...
class Reformat_1Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test 0") {
    ...
    val dfIn = createDfFromResourceFiles(
      ...
      "/data/io/prophecy/pipelines/pipeline1/graph/Reformat_1/in/data/unit_test_0.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/pipeline1/graph/Reformat_1/out/schema.json",
      "/data/io/prophecy/pipelines/pipeline1/graph/Reformat_1/out/data/unit_test_0.json",
      "out"
    )
  ...
  test("Unit Test 1") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/pipeline1/graph/Reformat_1/in/schema.json",
      "/data/io/prophecy/pipelines/pipeline1/graph/Reformat_1/in/data/unit_test_1.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/pipeline1/graph/Reformat_1/out/schema.json",
      "/data/io/prophecy/pipelines/pipeline1/graph/Reformat_1/out/data/unit_test_1.json",
      "out"
    )
  ...
  test("Unit Test 2") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/pipeline1/graph/Reformat_1/in/schema.json",
      "/data/io/prophecy/pipelines/pipeline1/graph/Reformat_1/in/data/unit_test_2.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/pipeline1/graph/Reformat_1/out/schema.json",
      "/data/io/prophecy/pipelines/pipeline1/graph/Reformat_1/out/data/unit_test_2.json",
      "out"
    )
