package simpledatalabs_27.applicationprojectext2dev2.pipeline.pipeline1.graph.Subgraph_2

import io.prophecy.libs._
import simpledatalabs_27.applicationprojectext2dev2.pipeline.pipeline1.graph.Subgraph_2.config.Context
