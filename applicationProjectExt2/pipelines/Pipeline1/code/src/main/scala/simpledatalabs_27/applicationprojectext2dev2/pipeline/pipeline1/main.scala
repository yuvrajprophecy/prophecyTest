...
object Main {
  ...
  def apply(context: Context): Unit = {
    ...
    val df_Subgraph_2 =
      simpledatalabs_27.applicationprojectext2dev2.subgraph.sg2.apply(
        simpledatalabs_27.applicationprojectext2dev2.subgraph.sg2.config
          .Context(context.spark, context.config.Subgraph_2),
        df_Reformat_1
      )
    val df_Subgraph_1 =
