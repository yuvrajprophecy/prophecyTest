...
def Formula_186(spark: SparkSession, in0: DataFrame) -> DataFrame:
    return in0\
        .withColumn("Anticipated Calls", col("yhat"))\
        .withColumn("Anticipated Lower", col("yhat_lower"))\
        .withColumn("Anticipated Upper", col("yhat_upper"))\
