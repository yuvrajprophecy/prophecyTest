...
def DynamicRename_3759(spark: SparkSession, in0: DataFrame) -> DataFrame:
    return in0.select(
        col("MBR_INDV_BE_KEY"), 
        col("YEARMONTH"), 
        ...
        col("Avg_PCB").alias("PCB"), 
        col("Avg_BCARE").alias("BCARE"), 
        ...
        col("Avg_BLUESELECT_").alias("BLUESELECT_"), 
        col("SUB_MBR_SK"), 
        ...
        col("Avg_BLUE_SELECT").alias("BLUE_SELECT"), 
        ...
        col("GRP_ZIP_CD_5"), 
        col("Avg_BLUE_ACCESS").alias("BLUE_ACCESS"), 
        col("Avg_PCBEXTRNL").alias("PCBEXTRNL"), 
