...
def DynamicRename_3758(spark: SparkSession, in0: DataFrame) -> DataFrame:
    return in0.select(
        col("MBR_INDV_BE_KEY"), 
        col("YEARMONTH"), 
        col("`Max_Average Age Females`").alias("Average Age Females"), 
        col("BLUE_ACCESS"), 
        col("`Medical INJURIES__POISONINGS_AND_DRUG_EFFECTS`").alias("Medical INJURIES__POISONINGS_AND_DRUG_EFFECTS"), 
        col("`Max_Group Months`").alias("Group Months"), 
        col("`Medical FACTORS_INFLUENCING_HEALTH_STATUS`").alias("Medical FACTORS_INFLUENCING_HEALTH_STATUS"), 
        col("`Max_Member Months`").alias("Member Months"), 
        col("MBR_RELSHP_NM"), 
        ...
        col("`Max_Apt Ind`").alias("Apt Ind"), 
        col("`Max_Male Percentage`").alias("Male Percentage"), 
        col("`Max_Spouse Age`").alias("Spouse Age"), 
        col("PCP_FLAG"), 
        ...
        col("AGE"), 
        col("Outpatient"), 
        col("Max_GRP_TOT_EMPL_CT").alias("GRP_TOT_EMPL_CT"), 
        col("`Max_Min_Dependent Age`").alias("Min_Dependent Age"), 
        col("MBR_DSBLTY_IN"), 
        col("EXPRNC_CAT_CD"), 
        ...
        col("`Max_Spouse Retired`").alias("Spouse Retired"), 
        col("Inpatient"), 
        ...
        col("Max_Members_on_Policy").alias("Members_on_Policy"), 
        col("BLUESELECT_"), 
        col("`Mail Order Drug Counts`").alias("Mail Order Drug Counts"), 
        col("GRP_MKT_SIZE_CAT_NM"), 
        col("`Max_Female Percentage`").alias("Female Percentage"), 
        ...
        col("`Max_Average Age Males`").alias("Average Age Males"), 
