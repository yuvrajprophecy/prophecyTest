...
def P1_COBALTHS_ed_rx_su(spark: SparkSession) -> DataFrame:
    return spark.read\
        .schema(
          StructType([
        ...
        .option("quote", "\"")\
        .option("sep", ",")\
        .csv("Z:\\Alteryx\\Jon\\Prophecy Test\\ED\\ENC_ED Files20240228015756\\P1.COBALTHS.ed_rx_subset_23-24_pt2.csv")
