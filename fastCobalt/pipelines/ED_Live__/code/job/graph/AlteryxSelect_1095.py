...
def AlteryxSelect_1095(spark: SparkSession, in0: DataFrame) -> DataFrame:
    return in0.select(
        col("Polypharmacy"), 
        col("row_id"), 
