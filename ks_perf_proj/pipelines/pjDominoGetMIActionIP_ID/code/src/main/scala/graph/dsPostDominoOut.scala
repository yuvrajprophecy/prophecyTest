...
object dsPostDominoOut {
  ...
  def apply(context: Context): DataFrame = {
    ...
    context.spark.read
      ...
      .schema(
        StructType(
          Array(
            ...
            StructField("STAF_NUM",       StringType,  true),
            ...
            StructField("CIN",            StringType,  true),
      ...
      .load(
        s"${Config.pUKDWTEMPFILEPATH}/${Config.pCLEANSEDDATASET}_DOMINO_PIB.ds"
      )
  }
